...
<header style="max-width:1600px;min-width:500px" id="home">
  <img src="image1.jpg" alt="Hamburger Catering" width="1600" height="800">
  ...
  &{info}
	<div class = "signin-container" style= "text-align:center">
		...
		<p><input style = "padding:5px;margin-left:25%;display:block;border:none;border-bottom:1px solid red;width:200px;height:40px;text-align:center;" type="text" placeholder="first name" required name="first name"></p>
		  <p><input style = "padding:5px;margin-left:25%;display:block;border:none;border-bottom:1px solid red;width:200px;height:40px;text-align:center;" type="text" placeholder="last name" required name="last name"></p>
		  ...
		  <p><input style = "padding:5px;margin-left:25%;display:block;border:none;border-bottom:1px solid red;width:200px;height:40px;text-align:center;" type="password" placeholder="confirm password" required name="confirm password"></p>
		  <p><input style = "padding:5px;margin-left:25%;display:block;border:none;border-bottom:1px solid red;width:200px;height:40px;text-align:center;" type="text" placeholder="phone number" required name="phone number"></p>
